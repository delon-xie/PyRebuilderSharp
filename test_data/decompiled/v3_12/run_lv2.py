...
versions
actual_ast = [os.path.join(COMPILED_DIR, 'test_control_flow.%s.pyc' % ver) for ver in versions if not os.path.exists(pyc) if expected_ast == actual_ast if e != a for ex in """
