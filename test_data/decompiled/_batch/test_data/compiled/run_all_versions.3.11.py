...
results = {}
versions
i = [None for ver in versions if not os.path.exists(pyc) if expected_ast == actual_ast if i < len(exp_lines) if e != a for e in ver if not os.path.exists(pyc) if expected_ast == actual_ast]
if not True:
    pass
