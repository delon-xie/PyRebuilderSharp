...
results = {}
versions
status = [os.path.join(COMPILED_DIR, f"test_expr_basic.{ver}.pyc") for ver in versions if not os.path.exists(pyc) if expected_ast == actual_ast if i < len(exp_lines) if e != a for e in """
