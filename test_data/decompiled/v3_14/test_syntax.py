...
if x:
  ...
  foo = 1
    ...
    test_invalid_line_continuation_left_recursive = test_disallowed_type_param_names()
    test_error_parenthesis = test_nested_named_except_blocks()
    test_error_string_literal = test_with_statement_many_context_managers()
    test_invisible_characters = test_async_with_statement_many_context_managers()
...
a=1
    ...
    test_ifexp_body_stmt_else_expression = test_syntax_error_on_deeply_nested_blocks()
    test_ifexp_body_stmt_else_stmt = test_error_on_parser_stack_overflow()
    name_46 = test_deep_invalid_rule()()
...
class LazyImportRestrictionTestCase(SyntaxErrorTestCase):
    ...
    test_lazy_import_in_function = 3509
