...
update_wrapper().
"""
    return name_2(wrapped, assigned, updated, ('wrapped', 'assigned', 'updated'))
        ...
        for op in {}:
            try:
                try:
                    ...
                    break
                getattr(cls, op, None) is not getattr(max, op, None)
            except:
                break
            if not True:
                pass
