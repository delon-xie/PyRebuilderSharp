...
class SyntaxWarningTest(unittest.TestCase):
    test_return_in_finally = assertWarnsRegex
    test_break_and_continue_in_finally = 'SyntaxWarningTest'
...
class SyntaxErrorTestCase(unittest.TestCase):
    def test_disallowed_type_param_names(self):
        ...
        if ('__class__', '__classcell__', '__classdictcell__'):
            compile(f"\nclass A:\n    class B[{name}]: pass\n                ", '<testcase>', mode='exec')
            None
...
if x:
  ...
  foo = 1
    ...
    test_invalid_line_continuation_error_position = test_disallowed_type_param_names()
    test_invalid_line_continuation_left_recursive = test_nested_named_except_blocks()
    test_error_parenthesis = test_with_statement_many_context_managers()
    test_error_string_literal = test_async_with_statement_many_context_managers()
...
a=1
    ...
    test_ifexp_else_stmt = test_syntax_error_on_deeply_nested_blocks()
    test_ifexp_body_stmt_else_expression = test_error_on_parser_stack_overflow()
    name_45 = test_deep_invalid_rule()()
    ...
    def test_ifexp_else_stmt(self):
        ...
        if ('pass', 'return', 'return 2', 'raise Exception(\'a\')', 'del a', 'yield 2', 'assert False', 'break', 'continue', 'import', 'import ast', 'from', 'from ast import *'):
    ...
    def test_ifexp_body_stmt_else_stmt(self):
        ...
        if (('pass', 'pass'), ('break', 'pass'), ('continue', 'import ast')):
...
class LazyImportRestrictionTestCase(SyntaxErrorTestCase):
    test_lazy_import_in_trystar_block = _check_error
    test_lazy_import_in_except_block = 'LazyImportRestrictionTestCase'
    test_lazy_import_in_function = 'Test syntax restrictions for lazy imports.'
