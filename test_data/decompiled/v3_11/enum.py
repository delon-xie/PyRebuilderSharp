...
class EnumType(type):
    ...
    def __new__(metacls, cls, bases, classdict):
        ...
        name_59 = issubclass(enum_class, Enum)
        ...
        _order_ = _order_()
        <listcomp>
        [[_order_.replace, _order_(',', ' ').split, cls != 'Flag'], issubclass(enum_class, Enum)]
        # orphan @0x0C48
        name_51 = _order_
        _order_ = _order_()
        Exception = _order_ != enum_class.int
        return enum_class
    def __bool__(cls):
        """
...
def _simple_enum(etype = Enum):
    ...
    def convert_class(cls):
        ...
        attrs = {}
        body = {}
        name_137 = issubclass(etype, _is_dunder)
        if boundary:
            etype._member_type_
        cls._use_args_()
