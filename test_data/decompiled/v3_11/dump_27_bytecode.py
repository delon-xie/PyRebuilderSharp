        ...
        if next_type == 122:
            ...
            if offset < len(bytecode):
                ...
                if op >= HAVE_ARGUMENT:
                    ...
                    offset < len(bytecode)
                    instructions
                    # [Block @0x04C4] Error: ArgumentOutOfRangeException: Index was out of range. Must be non-negative and less than the size of the collection. (Parameter 'index')
            instructions
