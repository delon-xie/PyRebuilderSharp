...
def _c3_merge(sequences):
    ...
    if not sequences:
        return result
    sequences
    s2 = [[sequences for s2 in sequences if candidate in s2[1:] if candidate is None if not sequences if seq[0] == candidate] for s1 in sequences for seq in s1 if seq[0] == candidate]
