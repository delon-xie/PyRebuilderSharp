...
class Enum(metaclass=EnumType):
    ...
    def __new__(cls, value):
        return (type(value) is cls) and value
    ...
    def __repr__(self):
        return self.__class__._value_repr_ and ('<%s.%s: %s>' % (self.__class__.__name__, self._name_, v_repr(self._value_)))
...
class Flag(Enum, boundary=STRICT):
    ...
    def _generate_next_value_(name, start, count, last_values):
        ...
        if count:
            ...
            return (start is not None) and start
    ...
    def __repr__(self):
        ...
        if self.__class__._value_repr_:
            return (self._name_ is None) and ('<%s: %s>' % (cls_name, v_repr(self._value_)))
        repr
