...
| Total orphan blocks | 5119 | ⚠️ |
| Total diff lines (added+removed) | 70200 | |
| Total diff lines per file (avg) | 74.5 | |
...
| 3.13 | 93 | 1 | 4 | 5 | 83 | 5% | 258 |
| 3.14 | 94 | 1 | 4 | 5 | 84 | 5% | 433 |
...
| abc.py | 3.13 | +132/−170 | 🔴 D | 15 | 143.8% |
| abc.py | 3.14 | +137/−170 | 🔴 D | 15 | 146.2% |
...
| enum.py | 3.13 | +998/−2008 | 🔴 D | 76 | 136.1% |
| enum.py | 3.14 | +1004/−2002 | 🔴 D | 90 | 136.1% |
...
| functools.py | 3.13 | +679/−1007 | 🔴 D | 78 | 142.2% |
| functools.py | 3.14 | +704/−994 | 🔴 D | 74 | 143.2% |
| pprint.py | 3.14 | +538/−838 | 🔴 D | 184 | 145.1% |
...
| reprlib.py | 3.13 | +114/−174 | 🔴 D | 11 | 124.7% |
| reprlib.py | 3.14 | +135/−164 | 🔴 D | 15 | 129.4% |
...
| 3.13 | 258 | abc.py, actual_lv2.py, check_versions.py, compare_ast.py, debug_exc.py... |
| 3.14 | 433 | abc.py, actual_lv2.py, check_versions.py, compare_ast.py, debug_exc.py... |
...
4. **Orphan blocks** (5119): Blocks that couldn't be placed in the AST, output with `# orphan` comment
...
| P3 | Orphan reduction (5119) | Strengthen `_processedBlockIds` | 4h |
...
| P3 | Reduce orphan blocks (5119) | 4h |
...
*Report generated by `tools/baseline_evaluate_all.py` on 2026-06-17 18:06*
