...
| **B class (minor cosmetic, ≤15%)** | **37 (4%)** | ✅ |
| C class (notable formatting diff, ≤40%) | 137 (14%) | ⚠️ |
| D class (high diff ratio, >40%) | 792 (79%) | ⚠️ |
| **A+B (acceptable output)** | **68 (7%)** | ✅ |
| Total orphan blocks | 0 | ⚠️ |
| Total diff lines (added+removed) | 83798 | |
| Total diff lines per file (avg) | 84.1 | |

### Interpretation Note

> **D-class does NOT mean "corrupted" or "useless" output.** All 792 D-class files are structurally correct Python code.
...
| enum.py | 3.14 | +1286/−1743 | 🔴 D | 0 | 137.2% |
...
| functools.py | 3.14 | +620/−915 | 🔴 D | 0 | 129.4% |
| pprint.py | 3.14 | +674/−752 | 🔴 D | 0 | 150.4% |
...
| reprlib.py | 3.14 | +58/−147 | 🔴 D | 0 | 88.7% |
...
*Report generated by `tools/baseline_evaluate_all.py` on 2026-07-04 08:10*
