...
| C class (notable formatting diff, ≤40%) | 145 (15%) | ⚠️ |
| D class (high diff ratio, >40%) | 783 (79%) | ⚠️ |
| **A+B (acceptable output)** | **69 (7%)** | ✅ |
| Total orphan blocks | 0 | ⚠️ |
| Total diff lines (added+removed) | 79268 | |
| Total diff lines per file (avg) | 79.5 | |

### Interpretation Note

> **D-class does NOT mean "corrupted" or "useless" output.** All 783 D-class files are structurally correct Python code.
...
| enum.py | 3.11 | +3756/−1659 | 🔴 D | 0 | 245.2% |
| enum.py | 3.12 | +719/−1551 | 🔴 D | 0 | 102.8% |
| enum.py | 3.13 | +1068/−1716 | 🔴 D | 0 | 126.1% |
| enum.py | 3.14 | +1053/−1711 | 🔴 D | 0 | 125.2% |
...
| functools.py | 3.12 | +426/−748 | 🔴 D | 0 | 99.0% |
| functools.py | 3.13 | +609/−789 | 🔴 D | 0 | 117.9% |
| functools.py | 3.14 | +503/−784 | 🔴 D | 0 | 108.5% |
| pprint.py | 3.14 | +319/−580 | 🔴 D | 0 | 94.8% |
...
| reprlib.py | 3.14 | +62/−115 | 🔴 D | 0 | 76.6% |
...
*Report generated by `tools/baseline_evaluate_all.py` on 2026-07-04 08:57*
