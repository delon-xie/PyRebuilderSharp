...
| Total orphan blocks | 4754 | ⚠️ |
| Total diff lines (added+removed) | 74850 | |
| Total diff lines per file (avg) | 79.5 | |
...
| abc.py | 3.13 | +136/−165 | 🔴 D | 2 | 143.3% |
| abc.py | 3.14 | +140/−164 | 🔴 D | 2 | 144.8% |
...
| enum.py | 3.14 | +1319/−2102 | 🔴 D | 64 | 154.9% |
...
| functools.py | 3.12 | +611/−865 | 🔴 D | 26 | 124.5% |
| functools.py | 3.13 | +711/−975 | 🔴 D | 26 | 142.2% |
| functools.py | 3.14 | +727/−971 | 🔴 D | 22 | 143.2% |
...
| 3.10 | 231 | actual_lv2.py, analyze_tests.py, check_csharp.py, check_v311.py, compare_ast.py... |
...
4. **Orphan blocks** (4754): Blocks that couldn't be placed in the AST, output with `# orphan` comment
...
| P3 | Orphan reduction (4754) | Strengthen `_processedBlockIds` | 4h |
...
| P3 | Reduce orphan blocks (4754) | 4h |
...
*Report generated by `tools/baseline_evaluate_all.py` on 2026-06-21 23:58*
