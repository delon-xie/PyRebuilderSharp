...
public static class VersionStrategyFactory
{
    ...
    public static IVersionStrategy Create(byte[] magic)
    {
        ...
        return magicHex switch
        {
            ...
            "330D0D0A" or "3B0D0D0A" or "400D0D0A" => new VersionStrategyPre311(is310: false, is38plus: false, is36: true),
            "420D0D0A" or "450D0D0A" or "4D0D0D0A" => new VersionStrategyPre311(is310: false, is38plus: false, is37: true),
