...
public class VersionStrategy312 : VersionStrategyBase
{
    ...
    public override int GetCacheCount(byte rawOp)
    {
        return rawOp switch
        {
            ...
            96 => 0, 97 => 0, 98 => 0, 99 => 0,
            100 => 1, // LOAD_CONST
            101 => 1, // LOAD_NAME (1 cache, CPython 3.12)
            102 => 1, 103 => 1, 104 => 1, 105 => 1, // BUILDs: 1 cache each
            106 => 4, 107 => 4, // LOAD_ATTR:4, COMPARE_OP:4
            108 => 0, 109 => 0, 110 => 0,
            111 => 2, 112 => 2, 113 => 0, 114 => 2, 115 => 2, // POP_JUMPs: 2 caches each
            116 => 0, // LOAD_GLOBAL
            117 => 0, 118 => 0, 119 => 0,
            ...
            166 => 0, 167 => 0,
            170 => 0,
            171 => 3, // CALL (3 caches, CPython 3.12)
